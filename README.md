...
| File | Scope | Content |
|---|---|---|
| `CODING_RULES.md` | All projects | 25 universal rules (money, caching, idempotency, testing, US English, bind-mounts, migration safety, licensing, sensitive-data privacy/safety, ADRs, API specs, etc.) |
